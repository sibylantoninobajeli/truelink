...
class OracleFabricBCWidget extends StatefulWidget {
  @override
  OracleFabricBCWidgetState createState() {
    return new OracleFabricBCWidgetState();
  }
}

class OracleFabricBCWidgetState extends State<OracleFabricBCWidget> {
  String clipboard = '';
